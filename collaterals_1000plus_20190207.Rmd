...
model_C <- lmrob(Tmax_6_reperf_rel~NIHSS_ad + iv_tPR + HIR1 + Rekan + circulation, data=allpts, setting = "KS2014")
plot(allpts$HIR1,allpts$Tmax_6_reperf_rel, xlab="HIR", ylab="Extent of reperfusion")

model_D <- lmrob(Tmax_6_reperf_rel~NIHSS_ad + iv_tPR + higashida_D1_bin + Rekan + circulation, data=allpts, setting = "KS2014")
...
model_A <- lmrob(Tmax_6_reperf_rel~NIHSS_ad + iv_tPR + circulation, data=allpts_nonrekan, setting = "KS2014")
...
model_B <- lmrob(Tmax_6_reperf_rel~NIHSS_ad + iv_tPR + HIR1 + circulation, data=allpts_nonrekan, setting = "KS2014")
plot(allpts_nonrekan$HIR1,allpts_nonrekan$Tmax_6_reperf_rel, xlab="HIR", ylab="Extent of reperfusion")

model_C <- lmrob(Tmax_6_reperf_rel~NIHSS_ad + iv_tPR + higashida_D1_bin + circulation, data=allpts_nonrekan, setting = "KS2014")
...
model_A <- lmrob(Tmax_6_reperf_rel~NIHSS_ad + iv_tPR + circulation, data=allpts_prekan, setting = "KS2014")
...
model_B <- lmrob(Tmax_6_reperf_rel~NIHSS_ad + iv_tPR + HIR1 + circulation, data=allpts_prekan, setting = "KS2014")
plot(allpts_prekan$HIR1,allpts_prekan$Tmax_6_reperf_rel, xlab="HIR", ylab="Extent of reperfusion")

model_C <- lmrob(Tmax_6_reperf_rel~NIHSS_ad + iv_tPR + higashida_D1_bin + circulation, data=allpts_prekan, setting = "KS2014")
...
model_A <- lmrob(Tmax_6_reperf_rel~NIHSS_ad + iv_tPR + circulation, data=allpts_frekan, setting = "KS2014")
...
model_B <- lmrob(Tmax_6_reperf_rel~NIHSS_ad + iv_tPR + HIR1 + circulation, data=allpts_frekan, setting = "KS2014")
plot(allpts_frekan$HIR1,allpts_frekan$Tmax_6_reperf_rel, xlab="HIR", ylab="Extent of reperfusion")

model_C <- lmrob(Tmax_6_reperf_rel~NIHSS_ad + iv_tPR + higashida_D1_bin + circulation, data=allpts_frekan, setting = "KS2014")
...
model_A <- lmrob(mRS_d90~HIR1 + circulation, data=allpts, setting = "KS2014")
...
model_B <- lmrob(mRS_d90~HIR1 + NIHSS_ad + iv_tPR + Rekan + Tmax_6_reperf_rel + circulation, data=allpts, setting = "KS2014")
...
model_C <- lmrob(mRS_d90~higashida_D1_bin + circulation, data=allpts, setting = "KS2014")
boxplot(allpts$HIR1~allpts$mRS_d90, xlab="mRS (day 90)", ylab="HIR")

model_D <- lmrob(mRS_d90~higashida_D1_bin + NIHSS_ad + iv_tPR  + Tmax_6_reperf_rel + Rekan + circulation, data=allpts, setting = "KS2014")
boxplot(allpts$mRS_d90~allpts$higashida_D1_bin, ylab="mRS (day 90)", xlab="Higashida score D1", xlim=c(0.5,2.5), outline=OL)

model_E <- lmrob(mRS_d90~Rekan*Tmax_6_reperf_rel + circulation, data=allpts, setting = "KS2014")

model_F <- lmrob(mRS_d90~Rekan*Tmax_6_reperf_rel + NIHSS_ad + iv_tPR + circulation, data=allpts, setting = "KS2014")
...
model_B <- lmrob(DWIgrowth~HIR1 + NIHSS_ad + iv_tPR + Tmax_6_reperf_rel + Rekan + circulation, data=allpts, setting = "KS2014")
...
model_D <- lmrob(DWIgrowth~higashida_D1_bin + NIHSS_ad + iv_tPR + Rekan + Tmax_6_reperf_rel + circulation, data=allpts, setting = "KS2014")
...
model_F <- lmrob(DWIgrowth~Rekan*Tmax_6_reperf_rel + NIHSS_ad + iv_tPR + circulation, data=allpts, setting = "KS2014")
...
model_B <- lmrob(infarct_growth_D5FLAIR~HIR1 + NIHSS_ad + iv_tPR + Rekan + Tmax_6_reperf_rel + circulation, data=allpts, setting="KS2014")
...
model_D <- lmrob(infarct_growth_D5FLAIR~higashida_D1_bin + NIHSS_ad + iv_tPR  + Rekan + Tmax_6_reperf_rel + circulation, data=allpts, setting="KS2014")
...
model_F <- lmrob(infarct_growth_D5FLAIR~Rekan*Tmax_6_reperf_rel + NIHSS_ad + iv_tPR + circulation, data=allpts, setting = "KS2014")
