...
plotreg(file="IG_models.pdf",mfrow=FALSE,list(model_B,model_D,model_F), custom.coef.names = list(c("Intercept","NIHSS on admission", "IV thrombolysis", "Partial recanalization", "Full recanalization", "HIR", "Posterior circulation", "Partial recanalization * HIR", "Full recanalization * HIR"),c("Intercept","NIHSS on admission", "IV thrombolysis", "Partial recanalization", "Full recanalization", "Poor Higashida score", "Posterior circulation", "Partial recanalization * Poor HS", "Full recanalization * Poor HS"),c("Intercept","NIHSS on admission", "IV thrombolysis", "Partial recanalization", "Full recanalization", "Reperfusion", "Posterior circulation", "Partial recanalization * Reperfusion", "Full recanalization * Reperfusion")),custom.model.names = c("","",""), ylab.cex = 1.3)
```
