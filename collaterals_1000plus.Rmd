...
### 6. What factors influence clinical outcome (mRS day90)?
...
### 7. What factors influence infarct growth?
```{r, echo= FALSE, fig.width=8, fig.height=6, fig.align='center',dpi=300, warning=F, results="asis"}
# perform robust GLM
model_7 <- lmrob(allpts$rel_DWIgrowth~allpts$Rekan + allpts$reperf + allpts$NIHSS_ad + allpts$iv_tPR + allpts$HIR1)
...
model_8 <- lmrob(allpts$DWIgrowth~allpts$Rekan + allpts$reperf + allpts$NIHSS_ad + allpts$iv_tPR + allpts$HIR1)
...
### 8. Is reperfusion associated with infarct growth?
```{r, echo= FALSE, fig.width=6, fig.height=6, fig.align='center',dpi=300, warning=F}
