...
# perform robust GLM
model_5 <- lmrob(allpts$mRS_d90~allpts$Rekan*allpts$reperf + allpts$NIHSS_ad + allpts$iv_tPR + allpts$mismatch_vol + allpts$HIR1)
...
```{r, echo= FALSE, fig.width=8, fig.height=6, fig.align='center',dpi=300, warning=F, results="asis"}
# perform robust GLM
model_6 <- lmrob(allpts$rel_DWIgrowth~allpts$Rekan*allpts$reperf + allpts$NIHSS_ad + allpts$iv_tPR + allpts$mismatch_vol + allpts$HIR1)
...
model_7 <- lmrob(allpts$DWIgrowth~allpts$Rekan*allpts$reperf + allpts$NIHSS_ad + allpts$iv_tPR + allpts$mismatch_vol + allpts$HIR1)
